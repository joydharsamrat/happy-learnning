...
const TopSection = () => {
    return (
        <div className='top-section text-center'>
            ...
            <Link to='/courses' className='btn mt-10 border-0 hover:bg-[#39b6a7] hover:scale-105 hover:text-black bg-[#2a9d8f]'>Checkout Our Courses <FaArrowRight className='ml-2'></FaArrowRight></Link>
        </div>
    );
};
