                ...
                <div className="carousel w-5/6 mx-auto">
                    <div id="item1" className="carousel-item w-full">
                        <div className='grid grid-cols-2 gap-5'>
                            <div className='p-3 bg-fuchsia-200 rounded-xl shadow-md'>
                            ...
                            <div className='p-5 bg-fuchsia-200 rounded-xl shadow-md'>
                    ...
                    <div id="item2" className="carousel-item w-full">
                        <div className='grid grid-cols-2 gap-5'>
                            <div className='p-3 bg-indigo-200 rounded-xl shadow-md'>
                            ...
                            <div className='p-5 bg-indigo-200 rounded-xl shadow-md'>
                    ...
                    <div id="item3" className="carousel-item w-full">
                        <div className='grid grid-cols-2 gap-5'>
                            <div className='p-3 bg-cyan-200 rounded-xl shadow-md'>
                            ...
                            <div className='p-5 bg-cyan-200 rounded-xl shadow-md'>
